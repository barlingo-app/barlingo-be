...
public class DataInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		log.info("== Users ==");
		User user1 = createUser("Cristina Alba", "Kuroiwa", "España", "Sevilla", "username1@gmail.com", "username1",
				"username", "https://cdn3.iconfinder.com/data/icons/business-avatar-1/512/4_avatar-128.png",
				"https://cdn.stocksnap.io/img-thumbs/280h/EKZ9QLRKFC.jpg", LocalDate.of(1993, 8, 27),
				Arrays.asList("es"), Arrays.asList("en", "de"), "es");
		User user2 = createUser("David", "Rodríguez Pérez", "España", "Sevilla", "username2@gmail.com", "username2",
				"username", "https://cdn3.iconfinder.com/data/icons/business-avatar-1/512/10_avatar-128.png",
				"https://cdn.stocksnap.io/img-thumbs/280h/2SFV3ZUNWZ.jpg", LocalDate.of(1991, 2, 26),
				Arrays.asList("es"), Arrays.asList("en", "de"), "es");
		User user3 = createUser("David", "Panadero Molina", "España", "Sevilla", "username3@gmail.com", "username3",
				"username", "https://cdn3.iconfinder.com/data/icons/business-avatar-1/512/7_avatar-128.png",
				"https://cdn.stocksnap.io/img-thumbs/280h/8BK8Y8YQLH.jpg", LocalDate.of(1990, 2, 26),
				Arrays.asList("es"), Arrays.asList("en", "de", "fr"), "es");
		User user4 = createUser("Francisco Javier", "Toucedo Campos", "España", "Sevilla", "username4@gmail.com",
				"username4", "username",
		...
		User user5 = createUser("María", "Muñoz de Burgos", "España", "Sevilla", "username5@gmail.com", "username5",
				"username", "https://cdn3.iconfinder.com/data/icons/business-avatar-1/512/3_avatar-128.png",
				"https://cdn.stocksnap.io/img-thumbs/280h/DHQEELXOQZ.jpg", LocalDate.of(1991, 12, 21),
				Arrays.asList("es"), Arrays.asList("en"), "es");

		log.info("== PayData ==");
		PayData payData1 = createPayData("Pago de Echate P'Alla Tapas", LocalDateTime.of(2019, 1, 1, 10, 00));
		PayData payData2 = createPayData("Pago de MonteCristo", LocalDateTime.of(2019, 1, 1, 10, 00));
		PayData payData3 = createPayData("Pago de Ronda el Alamillo", LocalDateTime.of(2019, 1, 1, 10, 00));
		PayData payData4 = createPayData("Pago de Oneills", LocalDateTime.of(2019, 1, 1, 10, 00));

		log.info("== Subscriptions ==");
		SubscriptionData subscription1 = createSubscriptionData(payData1.getMoment(), SubscriptionType.ANNUAL,
				config.getPriceMonthSubscription() - config.getPriceMonthSubscription() * config.getAnnualDiscount(),
				payData1, payData1.getMoment().plusMonths(SubscriptionType.ANNUAL.getMonths()));
		SubscriptionData subscription2 = createSubscriptionData(payData2.getMoment(), SubscriptionType.TRIMESTRAL,
		...
		SubscriptionData subscription3 = createSubscriptionData(payData3.getMoment(), SubscriptionType.ANNUAL,
				config.getPriceMonthSubscription() - config.getPriceMonthSubscription() * config.getAnnualDiscount(),
				payData3, payData3.getMoment().plusMonths(SubscriptionType.ANNUAL.getMonths()));
		SubscriptionData subscription4 = createSubscriptionData(payData4.getMoment(), SubscriptionType.MONTHLY,
				config.getPriceMonthSubscription(), payData4,
				payData4.getMoment().plusMonths(SubscriptionType.MONTHLY.getMonths()));

		log.info("== Establishments ==");
		Establishment establishment1 = createEstablishment("Ruben", "Rodríguez Pérez", "España", "Sevilla",
				"establishment1@gmail.com", "establishment1", "establishment", "Echate P'Alla Tapas",
				"Avenida de Sevilla 40",
				Arrays.asList("https://media-cdn.tripadvisor.com/media/photo-f/16/5e/b9/05/photo0jpg.jpg"),
				"https://media-cdn.tripadvisor.com/media/photo-f/16/5e/b9/05/photo0jpg.jpg", "06:00 - 00:00",
				"Cerveceza y tapa 1.50€", subscription1);
		Establishment establishment2 = createEstablishment("Juan Miguel", "Luza León", "España", "Sevilla",
				"establishment2@gmail.com", "establishment2", "establishment", "Ronda el Alamillo", "Ronda el Alamillo",
				Arrays.asList(
		...
		Establishment establishment3 = createEstablishment("Evaristo", "Ramírez Calvo", "España", "Sevilla",
				"establishment1@gmail.com", "establishment3", "establishment", "MONTECRISTO TERRAZA-BAR",
				"Calle Albareda, 16", Arrays.asList("http://media.tilllate.es/images/locations/ri_locbild1439178.jpg"),
				"http://media.tilllate.es/images/locations/ri_locbild1439178.jpg", "06:00 - 00:00", "Cerveceza 0.90€",
				subscription3);
		Establishment establishment4 = createEstablishment("Evaristo", "Ramírez Calvo", "España", "Sevilla",
				"establishment1@gmail.com", "establishment4", "establishment", "O'Neill's Irish Pub",
				"Calle Adriano, 34", Arrays.asList("https://www.facebook.com/159741280723607/photos/894861150544946/"),
				"https://www.facebook.com/159741280723607/photos/894861150544946/", "06:00 - 00:00", "Cerveceza 0.90€",
				subscription4);

		log.info("== Language Exchanges ==");
		LanguageExchange langExchange1 = createLanguageExchange("Language Exchange 1", "Language Exchange 1",
				LocalDateTime.of(2019, 1, 21, 10, 00), ExchangeState.CLOSE, 3, Arrays.asList("es", "en"),
				establishment1, user1, Arrays.asList(user1, user2), Arrays.asList());
		LanguageExchange langExchange2 = createLanguageExchange("Language Exchange 2", "Language Exchange 2",
				LocalDateTime.of(2019, 4, 5, 21, 00), ExchangeState.OPEN, 2, Arrays.asList("es", "en"), establishment1,
				user3, Arrays.asList(user3, user2), Arrays.asList());
		LanguageExchange langExchange3 = createLanguageExchange("Language Exchange 3", "Language Exchange 3",
				LocalDateTime.of(2019, 5, 21, 10, 00), ExchangeState.OPEN, 3, Arrays.asList("es", "en"), establishment1,
				user1, Arrays.asList(user1, user2, user4), Arrays.asList());

		log.info("== User Discounts ==");
		UserDiscount userDiscount1 = createUserDiscount("20190121-WERW", true, true, user1, langExchange1);
		UserDiscount userDiscount2 = createUserDiscount("20190121-WERE", true, true, user2, langExchange1);
		UserDiscount userDiscount3 = createUserDiscount("20190121-WERA", true, false, user3, langExchange2);
		UserDiscount userDiscount4 = createUserDiscount("20190121-WERQ", true, false, user2, langExchange2);
		UserDiscount userDiscount5 = createUserDiscount("20190121-WERR", false, false, user1, langExchange3);
		UserDiscount userDiscount6 = createUserDiscount("20190121-WERF", false, false, user2, langExchange3);
		UserDiscount userDiscount7 = createUserDiscount("20190121-WERO", false, false, user3, langExchange3);
	...
	private SubscriptionData createSubscriptionData(LocalDateTime initMoment, SubscriptionType subscriptionType,
			Double price, PayData paydata, LocalDateTime finishMoment) {
	...
	private LanguageExchange createLanguageExchange(String title, String description, LocalDateTime moment,
	...
	private UserDiscount createUserDiscount(String code, Boolean visible, Boolean exchanged, User user,
